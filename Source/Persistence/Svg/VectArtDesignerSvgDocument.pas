...
begin
  ...
  if Data.Filled and not TryParseFill(Node,FillText,Data.FillColor,Data.FillStyle) then
    Exit;
...
begin
  ...
  Result.FillStyle := RectangleData.FillStyle;
